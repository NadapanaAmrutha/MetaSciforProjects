# Generated by Django 5.1.2 on 2024-11-10 09:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce_app.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('products', models.ManyToManyField(to='ecommerce_app.cart')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce_app.customuser')),
            ],
        ),
        migrations.CreateModel(
